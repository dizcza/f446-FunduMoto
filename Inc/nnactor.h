...
#ifndef __AI_NNACTOR_H__
#define __AI_NNACTOR_H__
#pragma once
...
#define AI_NNACTOR_IN_1_SIZE_BYTES  ((1 * 1 * 2) * 4)
...
#define AI_NNACTOR_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 4)
