...
#include "nnactor_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NNACTOR_MODEL_NAME          "nnactor"
#define AI_NNACTOR_ORIGIN_MODEL_NAME   "ddpg_ultrasonicservov0"

/******************************************************************************/
#define AI_NNACTOR_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_NNACTOR_IN_NUM        (1)
#define AI_NNACTOR_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL), \
}
#define AI_NNACTOR_IN_SIZE { \
  AI_NNACTOR_IN_1_SIZE, \
}
#define AI_NNACTOR_IN_SIZE_BYTES { \
  AI_NNACTOR_IN_1_SIZE_BYTES, \
}
#define AI_NNACTOR_IN_1_HEIGHT      (1)
#define AI_NNACTOR_IN_1_WIDTH       (1)
#define AI_NNACTOR_IN_1_CHANNEL     (2)
#define AI_NNACTOR_IN_1_SIZE        (1 * 1 * 2)
#define AI_NNACTOR_IN_1_SIZE_BYTES  (AI_NNACTOR_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_NNACTOR_OUT_NUM       (1)
#define AI_NNACTOR_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL), \
}
#define AI_NNACTOR_OUT_SIZE { \
  AI_NNACTOR_OUT_1_SIZE, \
}
#define AI_NNACTOR_OUT_SIZE_BYTES { \
  AI_NNACTOR_OUT_1_SIZE_BYTES, \
}
#define AI_NNACTOR_OUT_1_HEIGHT      (1)
#define AI_NNACTOR_OUT_1_WIDTH       (1)
#define AI_NNACTOR_OUT_1_CHANNEL     (2)
#define AI_NNACTOR_OUT_1_SIZE        (1 * 1 * 2)
#define AI_NNACTOR_OUT_1_SIZE_BYTES  (AI_NNACTOR_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_NNACTOR_N_NODES (4)
 ...
 * @ref ai_nnactor_create. Both the activations memory buffer 
 ...
 * using @ref ai_nnactor_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NNACTOR_*
 * defines into file @ref nnactor.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
